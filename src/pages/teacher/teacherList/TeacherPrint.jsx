          ...
          <div className="mb-4 flex items-center justify-between">
           ...
           <div className="flex space-x-4">
             <ReactToPrint
               ...
               documentTitle={`${teacherData?.teacher_name || 'Teacher'}_Report`}
             />
             <button 
               onClick={handlePdf} 
              ...
              <div className="bg-white border border-gray-300">
                ...
                >
                    ...
                    <div className="w-4/5 flex flex-col space-y-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="border-l-2 border-gray-400 pl-4">
                          <h1 className="text-2xl font-bold text-gray-800">Teacher Information </h1>
                          <p className="text-sm text-gray-600">Academic Year: {selectedYear}</p>
                        </div>
                      </div>
                      
                      <div className="mt-2 bg-white p-3 rounded-md shadow-sm">
                        <h2 className="text-xl font-bold text-gray-800">{teacherData?.teacher_title} {teacherData?.teacher_name}</h2>
                        <div className="flex flex-wrap gap-x-4 mt-1">
                          <p className="text-sm bg-blue-50 px-2 py-1 rounded">{teacherData?.teacher_designation}</p>
                          <p className="text-sm bg-gray-100 px-2 py-1 rounded">ID: {teacherData?.teacher_ref}</p>
                          <p className="text-sm bg-gray-100 px-2 py-1 rounded">Qualification: {teacherData?.teacher_qualification || "N/A"}</p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="p-4">
                    ...
                    <div className="mb-3">
                      ...
                      <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm mt-3">
                        <div className="flex items-center">
                          ...
                          <span>{teacherData?.teacher_title} {teacherData?.teacher_name || "N/A"}</span>
                        </div>
                        <div className="flex items-center">
                        ...
                        <div className="flex items-center">
                          ...
                          <span className="mx-2">:</span>
                          <span>{teacherData?.teacher_designation || "N/A"}</span>
                        </div>
                        <div className="flex items-center">
                          <span className="font-medium w-32">Qualification</span>
                          <span className="mx-2">:</span>
                          <span>{teacherData?.teacher_qualification || "N/A"}</span>
                        </div>
                        <div className="flex items-center">
                          <span className="font-medium w-32">Date of Birth</span>
                          <span className="mx-2">:</span>
                          <span>{teacherData?.teacher_dob ? moment(teacherData.teacher_dob).format("DD-MM-YYYY") : "N/A"}</span>
                        </div>
                        <div className="flex items-center">
                          <span className="font-medium w-32">Date of Joining</span>
                          <span className="mx-2">:</span>
                          <span>{teacherData?.teacher_doj ? moment(teacherData.teacher_doj).format("DD-MM-YYYY") : "N/A"}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mb-3">
                      <h3 className="text-base font-bold border-b border-gray-300 mb-2 pb-1">CONTACT INFORMATION</h3>
                      <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm mt-3">
                        <div className="flex items-center">
                        ...
                        <div className="flex items-center">
                          ...
                          <span className="mx-2">:</span>
                          <span>{teacherData?.teacher_emergency_no || "N/A"}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mb-3">
                      <h3 className="text-base font-bold border-b border-gray-300 mb-2 pb-1">IDENTITY INFORMATION</h3>
                      <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm mt-3">
                        <div className="flex items-center">
                    ...
                    <div className="mb-3">
                      <h3 className="text-base font-bold border-b border-gray-300 mb-2 pb-1">BANK DETAILS</h3>
                    ...
                    <div className="mt-48 grid grid-cols-3 gap-4 text-sm">
                      <div className="text-center">
                        ...
                        <div className="text-xs text-gray-900">({teacherData?.teacher_name})</div>
                      </div>
                    ...
                    <div className="mt-8 pt-2 border-t border-gray-300 text-xs">
                      <div className="grid grid-cols-3 text-center text-gray-900">
                        <div>REF: {teacherData?.teacher_ref}/{moment().format("YYYY/MM")}</div>
