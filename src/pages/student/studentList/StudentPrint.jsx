...
import { VIEW_STUDENT_BY_ID } from "../../../components/common/UseApi";
...
const StudentPrint = () => {
  ...
  const fetchStudentData = async () => {
    try {
      setLoading(true);
      const response = await VIEW_STUDENT_BY_ID(selectedYear, id, token);
      console.log(response);
      // if (!response?.student?.student_photo) {
      //   setLoading(true);
                  ...
                  <div className="p-5 border-b w-full flex items-start gap-4 border-gray-300 bg-gray-50">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="border-l-2 border-gray-400 pl-4">
                          ...
                          <p className="text-sm text-gray-600">
                            Academic Year:{" "}
                            {studentData?.student_year || selectedYear}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="mt-2 bg-white p-3 rounded-md shadow-sm">
                        ...
                        <div className="flex flex-wrap gap-x-4 mt-1">
                          ...
                          <p className="text-sm bg-gray-100 px-2 py-1 rounded">
                            ID: {studentData?.student_admission_no || "N/A"}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="w-1/5 h-48 border border-gray-300 shadow-md overflow-hidden rounded-md">
                      ...
                      <img
                        src={
                          studentPhotoBase64 ||
                          `/api/public/assets/student/${studentData?.student_photo}`
                        }
                        alt="Student Photo"
                  ...
                  <div className="p-4">
                    ...
                    <div className="mb-3">
                      ...
                      <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm mt-3">
                        ...
                        <div className="flex items-center">
                          ...
                          <span className="mx-2">:</span>
                          <span>
                            {studentData?.student_admission_no || "N/A"}
                          </span>
                        </div>
                        <div className="flex items-center">
                          <span className="font-medium w-32">
                            Class{" "}
                            <span className="text-[10px]">(when joined)</span>
                          </span>
                          <span className="mx-2">:</span>
                        ...
                        <div className="flex items-center">
                          ...
                          <span>
                            {studentData?.student_dob
                              ? moment(studentData.student_dob).format(
                                  "DD-MM-YYYY"
                                )
                              : "N/A"}
                          </span>
                        ...
                        <div className="flex items-center">
                          ...
                          <span className="mx-2">:</span>
                          <span>
                            {studentData?.student_admission_date
                              ? moment(
                                  studentData.student_admission_date
                                ).format("DD-MM-YYYY")
                              : "N/A"}
                        ...
                        <div className="flex items-center">
                          ...
                          <span className="mx-2">:</span>
                          <span>
                            {studentData?.student_primary_no || "N/A"}
                          </span>
                        </div>
                        <div className="flex items-center">
                    ...
                    <div className="mb-3">
                      ...
                      <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm mt-3">
                        <div className="flex items-center">
                          ...
                          <span className="mx-2">:</span>
                          <span>
                            {studentData?.student_father_name || "N/A"}
                          </span>
                        </div>
                        <div className="flex items-center">
                          <span className="font-medium w-32">
                          ...
                          <span className="mx-2">:</span>
                          <span>
                            {studentData?.student_father_mobile || "N/A"}
                          </span>
                        </div>
                        <div className="flex items-center">
                          ...
                          <span className="mx-2">:</span>
                          <span>
                            {studentData?.student_father_pan_no || "N/A"}
                          </span>
                        </div>
                        <div className="flex items-center">
                          <span className="font-medium w-32">
                          ...
                          <span className="mx-2">:</span>
                          <span>
                            {studentData?.student_father_adhar_no || "N/A"}
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mb-3">
                      ...
                      <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm mt-3">
                        <div className="flex items-center">
                          ...
                          <span className="mx-2">:</span>
                          <span>
                            {studentData?.student_mother_name || "N/A"}
                          </span>
                        </div>
                        <div className="flex items-center">
                          <span className="font-medium w-32">
                          ...
                          <span className="mx-2">:</span>
                          <span>
                            {studentData?.student_mother_mobile || "N/A"}
                          </span>
                        </div>
                        <div className="flex items-center">
                          <span className="font-medium w-32">PAN Number</span>
                          <span className="mx-2">:</span>
                          <span>
                            {studentData?.student_mother_pan_no || "N/A"}
                          </span>
                        </div>
                        <div className="flex items-center">
                          <span className="font-medium w-32">
                          ...
                          <span className="mx-2">:</span>
                          <span>
                            {studentData?.student_mother_adhar_no || "N/A"}
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mt-48 grid grid-cols-3 gap-4 text-sm">
                      <div className="text-center">
                        ...
                        <div className="text-xs text-gray-900">
                          ({studentData?.student_father_name || "Parent"})
                        </div>
                      </div>
                    ...
                    <div className="mt-8 pt-2 border-t border-gray-300 text-xs">
                      <div className="grid grid-cols-3 text-center text-gray-900">
                        <div>
                          REF: {studentData?.student_admission_no}/
